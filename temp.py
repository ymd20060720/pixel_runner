...
#test_surface = pygame.Surface((800,50)) #width,height (topleft = 0,0) max800,400
...
#score
#score_surf = test_font.render('Hallo world', False, (64,64,64)) #text, anti-aliase, color
#score_rect = score_surf.get_rect(center = (400, 50))
...
while True:
    ...
    if game_active:
        ...
        #pygame.draw.line(screen, 'Gold',(0,0),mouse_pos,5)
